...
void ParseUtils::ParseConfigFile(const std::string & filename)
{
    ...
    if (doc.HasMember("Tools") && doc["Tools"].IsObject())
    {
		...
		JSONTools::ReadInt("wb", tool, Config::Tools::wb);
		JSONTools::ReadInt("wf", tool, Config::Tools::wf);
		JSONTools::ReadInt("wu", tool, Config::Tools::wu);
		JSONTools::ReadInt("we", tool, Config::Tools::we);
		JSONTools::ReadInt("Window", tool, Config::Tools::Window);
		JSONTools::ReadInt("OpeningWindow", tool, Config::Tools::OpeningWindow);
		JSONTools::ReadBool("RandomStartingStrat", tool, Config::Tools::RandomStartingStrat);
		JSONTools::ReadBool("fuc", tool, Config::Tools::fuc);
		JSONTools::ReadBool("fbc", tool, Config::Tools::fbc);
		JSONTools::ReadBool("euc", tool, Config::Tools::euc);
		JSONTools::ReadBool("ebc", tool, Config::Tools::ebc);
    }
