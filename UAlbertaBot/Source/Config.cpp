...
namespace Config
{
    namespace ConfigFile
    {
        ...
        std::string ConfigFileLocation      = "bwapi-data/AI/NewSouthBot_Config.txt";
		std::string DatabaseFileLocation = "C:/Program Files/Starcraft/bwapi-data/AI/PvT_db.txt";
    }
    ...
    namespace BotInfo
    {
        std::string BotName                 = "NewSouthBot";
        std::string Authors                 = "Kevin Lerdwichagul";
    ...
    namespace Tools								
    {
		...
		extern int wb = 1;
		extern int wu = 1;
		extern bool fuc = true;
		extern bool fbc = true;
		extern bool euc = true;
		extern bool ebc = true;
		extern bool RandomStartingStrat = true;
		extern int OpeningWindow = 20;
		extern int Window = 15;
    }
}